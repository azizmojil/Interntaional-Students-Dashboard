...
NATIONALITY_MAPPING = {
    ...
    "ترينيداد وتوباغو ": {"country_ar": "ترينيداد وتوباغو", "country_en": "Trinidad and Tobago", "continent": "أمريكا اللاتينية"},
    ...
    "جامايكي": {"country_ar": "جامايكا", "country_en": "Jamaica", "continent": "أمريكا اللاتينية"},
    ...
    "جزر فيرجين البريطانية ": {"country_ar": "جزر فيرجن البريطانية", "country_en": "British Virgin Islands", "continent": "أمريكا اللاتينية"},
    ...
    "دومينيكي": {"country_ar": "جمهورية الدومينيكان", "country_en": "Dominican Republic", "continent": "أمريكا اللاتينية"},
    ...
    "سانت كيتس ونيفس ": {"country_ar": "سانت كيتس ونيفيس", "country_en": "Saint Kitts and Nevis", "continent": "أمريكا اللاتينية"},
